...
def main(page: ft.Page):
    ...
    cabecalho = ft.Row(
        controls=[
            ...
            ft.Column(
                controls=[
                    ft.Text("arth;-;", size=24,
                            weight="bold", color="white"),
                    ft.Text("Nível 2704 - arth",
    ...
    status_bar = ft.Row(
        controls=[
            ...
            ft.Container(
                content=ft.Text(
                    "mp: 70", text_align=ft.TextAlign.CENTER, weight="bold"),
                bgcolor="blue400", padding=10, border_radius=8, expand=3
            ),
            ft.Container(
                content=ft.Text(
                    "xp: 50", text_align=ft.TextAlign.CENTER, weight="bold"),
                bgcolor="amber400", padding=10, border_radius=8, expand=4
            ),
        ],
        spacing=10
    )
